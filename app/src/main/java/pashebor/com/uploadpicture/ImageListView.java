...
public class ImageListView extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    public static final String GET_IMAGE_URL="http://pashebor.rurs.net/getAllImages.php";
    ...
    private void getImages(){
        class GetImages extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ImageListView.this,"Загрузка...","Подожди...",false,false);
            }
    ...
    private void getURLs() {
        class GetURLs extends AsyncTask<String,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ImageListView.this,"Загрузочка...","Ждите...",true,true);
            }
